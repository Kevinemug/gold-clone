...
<div  className=' lg:absolute left-10 mt-10 lg:mt-[430px] lg:ml-[50%] lg:hidden'>
  <div>
    <img src="https://www.gold.ac.uk/media/images-by-section/course-finder/short-courses/Art-Psychotherapy-shows_-2015_11156.jpg" alt="" />
  </div>
  {/* crd */}
  <div  className='px-4 relative top-[-20px] lg:top-[-270px] lg:left-[300px]'>
  <div className='bg-white py-10 lg:w-[50%]  '>
    <div className='flex gap-5  flex-col justify-center items-center'>
      <p className='text-black font-medium text-center p-2 text-xl'>Many of our short courses are available via live </p>
      <p className='w-[70%] px-3 text-center lg:hidden'> Lorem ipsum Lorem ipsum dolor sit amet. dolor sit amet consectetur adipisicing elit. Porro, itaque!</p>
    </div>
<hr className='ml-6 mr-6 mt-10 py-4'/>
<div className='flex justify-between px-6 pb-4'>
  <p className='text-[#646ec0] font-medium'> Short courses</p>
  <div>
    <img src="https://www.gold.ac.uk/assets/img/svg/sprite/icon-more-666.svg" alt="" />
  </div>
</div>
...
<div className='lg:w-[200px] '>
  ...
  <div className='flex justify-center  flex-col pt-5 items-center'>
    ...
    <img src="https://www.gold.ac.uk/assets/img/svg/sprite/icon-calendar-999.svg" alt="" />
    <div className='text-[#666666] '>Exhibition</div>
    </div>
    <div className='text-[#666666]'>18 ju 2023, 9am-9.00pm</div>
  </div>
</div>
...
<div className='bg-roww bg-contain lg:hidden  m-auto bg-no-repeat  h-[200px]'></div>
</main>
